...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.answer_img_label = QLabel(Frame)
        self.answer_img_label.setObjectName(u"answer_img_label")
        sizePolicy1 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Maximum)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.answer_img_label.sizePolicy().hasHeightForWidth())
        self.answer_img_label.setSizePolicy(sizePolicy1)
        self.answer_img_label.setMinimumSize(QSize(150, 100))
        self.answer_img_label.setAlignment(Qt.AlignCenter)

        self.gridLayout_2.addWidget(self.answer_img_label, 3, 2, 1, 1)

        self.direction_img_label = QLabel(Frame)
        self.direction_img_label.setObjectName(u"direction_img_label")
        sizePolicy1.setHeightForWidth(self.direction_img_label.sizePolicy().hasHeightForWidth())
        self.direction_img_label.setSizePolicy(sizePolicy1)
        ...
        self.answer_label = QLabel(Frame)
        ...
        self.answer_label.setMinimumSize(QSize(150, 25))
        self.answer_label.setAlignment(Qt.AlignCenter)

        self.gridLayout_2.addWidget(self.answer_label, 2, 2, 1, 1)
        ...
        sizePolicy2.setHeightForWidth(self.study_select_label.sizePolicy().hasHeightForWidth())
        self.study_select_label.setSizePolicy(sizePolicy2)
        ...
        sizePolicy3.setHeightForWidth(self.char_child_combo.sizePolicy().hasHeightForWidth())
        self.char_child_combo.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.char_parent_combo.sizePolicy().hasHeightForWidth())
        self.char_parent_combo.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.study_img_label.sizePolicy().hasHeightForWidth())
        self.study_img_label.setSizePolicy(sizePolicy4)
        self.study_img_label.setMinimumSize(QSize(0, 208))
        self.study_img_label.setAlignment(Qt.AlignCenter)

        self.verticalLayout_2.addWidget(self.study_img_label)

        self.example_img_label = QLabel(Frame)
        self.example_img_label.setObjectName(u"example_img_label")
        sizePolicy4.setHeightForWidth(self.example_img_label.sizePolicy().hasHeightForWidth())
        self.example_img_label.setSizePolicy(sizePolicy4)
        self.example_img_label.setMinimumSize(QSize(0, 208))
        self.example_img_label.setAlignment(Qt.AlignCenter)

        self.verticalLayout_2.addWidget(self.example_img_label)
        ...
        self.gridLayout_2.addLayout(self.verticalLayout_2, 0, 5, 4, 1)
    ...
    def retranslateUi(self, Frame):
        ...
        self.answer_img_label.setText(QCoreApplication.translate("Frame", u"\uc218\ud615 \uc77c\uce58 \uc774\ubbf8\uc9c0", None))
        self.direction_img_label.setText(QCoreApplication.translate("Frame", u"\ubc29\ud5a5 \uc774\ubbf8\uc9c0", None))
        self.answer_label.setText(QCoreApplication.translate("Frame", u"\uc218\ud615", None))
        ...
        self.example_img_label.setText(QCoreApplication.translate("Frame", u"\ud559\uc2b5 \uc608\uc2dc \uc774\ubbf8\uc9c0", None))
    # retranslateUi
